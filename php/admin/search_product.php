...
<body>
<a class="back" href="main_page_admin.php"><i class="fa fa-arrow-left"></i></a>
  <div class="header">
  <h2 style="text-align:center">That result that your searching ....</h2>
  </div>
  <?php

$con = mysqli_connect("localhost","sopmycom_adminmyshop","i58[uBtsBU#k") or die("Unable to connect");
mysqli_select_db($con,"sopmycom_myshop");
