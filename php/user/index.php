...
<html>
   ...
   <img src="/project/images/logo.png" alt="Logo" >
    ...
    <div class="navbar">
    <a href="/project/php/user/edituserprofile.php" class="right"><i class="fa fa-user-circle"></i>    Profile</a>
		<a href="/project/php/user/login.php" class="right"><i class="fa fa-sign-out"></i>    Logout</a>
		<a href="/project/php/user/mycart.php" class="right"><i class="fa fa-user-circle"></i>    MyCart</a>
	</div>
   <center>
...
font-size: 15.0;"></i></button></button>
  ...
  mysqli_select_db($conn,"sopmycom_myshop"); 
         ...
         <div class="column-card" >
            <div class="card">
               ...
               <div class="right">
                  ...
                  <a href='cart.php?prid=<?php echo $row['prid']; ?>' class='fa fa-shopping-cart' style="text-decoration: none; color:black; font-weight: bold; font-size: 25px; padding-left:30px"> &nbsp&nbsp </a>
               </div>
            </div>
         </div>
         <?php
    ...
    <br>
    <br>
     <!-- <a href="/project/php/user/newproduct.php" class="float">
